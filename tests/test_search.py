...
class TestSearchCLI:
    ...
    def test_search_complex_query_repos(self, mock_asyncio_run):
        ...
        runner = CliRunner()
        result = runner.invoke(app, [
            "search", "repos", "language:python stars:>1000"
        ])
    ...
    def test_search_complex_query_users(self, mock_asyncio_run):
        ...
        runner = CliRunner()
        result = runner.invoke(app, [
            "search", "users", "location:London followers:>100"
        ])
    ...
    def test_search_special_characters_query(self, mock_asyncio_run):
        ...
        runner = CliRunner()
        result = runner.invoke(app, [
            "search", "repos", "test+repo-name_with.special"
        ])
